          ...
          <div class="flex justify-between h-20 items-center">
            ...
            <div class="flex items-center space-x-6">
              ...
              <a 
                ...
                class="flex items-center gap-2 text-sm font-bold text-gray-700 hover:text-orange-600 transition-colors"
              >
              ...
              <button 
                (click)="toggleCart()"
                class="relative p-2 text-gray-700 hover:bg-gray-100 rounded-full transition-all"
              >
        ...
        <aside class="fixed right-0 top-0 h-full w-full max-w-md bg-white z-[70] shadow-2xl flex flex-col animate-slide-in">
          ...
          <div class="p-6 border-t bg-gray-50 rounded-t-3xl">
            ...
            <button 
              ...
              (click)="confirmOrder()"
              class="w-full bg-green-600 text-white py-4 rounded-2xl font-black hover:bg-green-700 transition-all shadow-xl shadow-green-100 disabled:opacity-50 flex items-center justify-center gap-2"
            >
              @if (loading()) {
